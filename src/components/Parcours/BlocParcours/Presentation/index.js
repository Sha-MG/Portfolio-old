  ...
  return (
    ...
    <>
      <div className='BlocParcours-container--presentation' id='parcours'>
        ...
        <br/><p><HoverBurst><strong>Apprendre</strong></HoverBurst> de nouvelles choses ne me fait pas peur, je dirais même que j'adore ça ! Je suis <HoverBurst><strong>curieuse</strong></HoverBurst>, et chaque petit problème est un challenge qui me donne envie de me dépasser pour le résoudre.</p>
        ...
        <p><br/>Si mon profil vous intéresse, si vous avez une question, ou même si vous voulez me dire deux mots sur votre artiste favori, n'hésitez pas à  me contacter ! </p>
