  ...
  return (
    ...
    <>
      ...
      <div className='BlocParcours-container--presentation'>
        ...
        Le point commun à toutes ces expériences c'est <HoverBurst><strong>l'interaction</strong></HoverBurst> avec autrui, qu'elle soit visuel ou non. Suciter une émotion, produire quelque chose de beau, intéragir en direct ou via un support, c'est ça que je recherche principalement.</p>
        ...
        <p>Pour finir, la <HoverBurst><strong>créativité</strong></HoverBurst> est au centre de toutes mes activitées professionnelles et personnelles. L'imagination et l'art sont des composantes essentielles de mon quotidien. </p>
        <p><br/>Si mon profil vous intéresse, que vous avez une question, ou même que vous voulez me dire deux mots sur votre artiste favoris, n'hésitez pas à  me contacter ! </p>
